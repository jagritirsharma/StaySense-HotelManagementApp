...
# ===================title============
        ...
        lbl_title=Label(self.root,text="Room Booking Details", font=("Montserrat",18),bg="#4A4947",fg="#D8D2C2",bd=0)
...
# =============logo====================
 ...
 #=================labelFrame===================
        labelframeleft =LabelFrame( self.root ,bd=2, relief =RIDGE, text = "Room Details",  font=("Montserrat",12, "bold"), padx=2)
...
# Fetch Data btn=================
        btnFetchData=Button(labelframeleft,command=self.Fetch_contact ,text="Fetch Data",font=("arial",8, "bold"), bg="green", fg="white", width=8)
...
#==============Bill Button============================
        btnBill=Button(labelframeleft, text="Bill",command=self.total, font=("arial",11, "bold"), bg="green", fg="white", width=10)
...
#==========================Rightside image==============================
        ...
        img3=Image.open(r"C:\Users\HP\OneDrive\Desktop\Hotel_Management_System\images\bed.jpg")
...
#==========================table frame search system===========================
        ...
        btnSearch=Button(Table_Frame, text="Search", command=self.search,font=("arial",11, "bold"), bg="green", fg="white", width=10)
        btnSearch.grid(row=0, column=3, padx=2)

        btnShowall=Button(Table_Frame, text="Show All", command=self.fetch_data,font=("arial",11, "bold"), bg="green", fg="white", width=10)
...
#get cursor
    ...
    def mDelete(self):
        mDelete=messagebox.askyesno("Hotel Management System", "Do you want to delete this customer's room detail?", parent=self.root)
        if mDelete>0:
            conn = mysql.connector.connect(
            host=SQL_HOST,
            user=SQL_USER,
